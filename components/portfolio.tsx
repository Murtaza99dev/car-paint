...
const Portfolio = () => {
  return (
    <div className='w-full h-screen bg-slate-100'>
        ...
        <div className='grid grid-cols-4 mx-24 mt-12 gap-6' >
            ...
            <Image src={G5} alt="" className='-mt-[118px] transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-1000' />
            <Image src={G6} alt="" className='transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-700'/>
            <Image src={G7} alt="" className='-mt-[134px] transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-700' />
            <Image src={G8} alt="" className='-mt-[220px] transition ease-in-out delay-150 hover:translate-y-1 hover:scale-110 duration-700'/>
