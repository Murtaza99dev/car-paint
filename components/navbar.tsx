...
const Navbar = () => {
    return (
        <div>
            <div>
                <nav className='bg-black flex absolute w-full mt-12 opacity-90 h-20 md:h-16 md:mt-8 md:bg-cover md:w-screen'>
                    <div className='bg-red ml-48 absolute -mt-12 w-[200px] h-[180px] md:w-[180px] md:h-[180px]'>
                        <Image src={Logo} alt="logo" className='mt-12' />
                    </div>
                    <div className='w-full'>
                        <ul className='text-white flex justify-end mt-6 mr-12 text-xl font-bold md:text-sm'>
                            ...
                            <li className='justify-between mr-8 border-none bg-red w-28 text-center rounded-sm md:h-6 md:hover:text-red md:hover:bg-white '><a href="">Book Now</a></li>
