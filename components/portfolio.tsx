  ...
  return (
    <div className='w-full bg-slate-100 md:w-full md:h-full md:mt-0'>
      ...
      <div className='flex justify-center mt-8 gap-4 mx-4 '>
        ...
        <button onClick={handleOpen} type='submit' className='bg-red h-12 w-[90px] rounded-lg font-bold text-white cursor-pointer hover:bg-white hover:text-red'>Car Paint</button>
