...
const Testimonial = () => {
    return (
        <div className=' w-full h-screen'>
            <div className='absolute text-center w-full mt-12 text-6xl text-red font-bold'>

                <h1>Testimonials</h1>
                <p className='text-white text-2xl font-semibold mt-2'>People Love Us</p>
            </div>
            <div className='absolute mt-[200px] flex gap-12 justify-center w-full'>
                <div className='w-72 h-[500px] bg-red opacity-80'>
                    <Image src={T1} alt="" className='w-[250px] h-[250px] ml-[19px] mt-[18px]' />
                ...
                <div className='w-72 h-[500px] bg-red opacity-80'>
                    <Image src={T2} alt="" className='w-[250px] h-[250px] ml-[19px] mt-[18px]' />
                ...
                <div className='w-72 h-[500px] bg-red opacity-80'>
                    <Image src={T3} alt="" className='w-[250px] h-[250px] ml-[19px] mt-[18px]' />
